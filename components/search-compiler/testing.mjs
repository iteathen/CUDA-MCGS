...
import * as programPackageCore from './src/program-package-core.mjs';
...
export const protectedNoImportProgramPackageOracle = Object.freeze({
  ...
  composeSearchProgram: programPackageCore.composeSearchProgram,
  buildExecutionPackage: programPackageCore.buildExecutionPackage,
});
