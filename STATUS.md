...
```text
bb49b858eae1eb58c659664aeaca1c3a820b4c2c
```
...
SPEC-0001 and SPEC-0002 remain accepted foundational authority. SPEC-0000, SPEC-0003 through SPEC-0008 and SPEC-0010 remain proposals requiring review/revision and integrated evidence before their owned production implementation.
...
Current focus is **ENGINE-CONTRACT-01** under parent plan `CUDA-MCGS-V0/22`. Its critical assessment and semantic focus-branch map are [`docs/development/2026-08-24-engine-contract-01-assessment-and-plan.md`](docs/development/2026-08-24-engine-contract-01-assessment-and-plan.md). `EC-DOMAIN-01`, `EC-GRAPH-01` and `EC-POLICY-01` are integrated as proposals [`SPEC-0007`](docs/specs/SPEC-0007-domain-state-action-and-transition.md), [`SPEC-0010`](docs/specs/SPEC-0010-graph-storage-and-reclamation.md) and [`SPEC-0008`](docs/specs/SPEC-0008-search-policy-and-backup.md). `EC-EVALUATOR-01` is the single active leaf. Device-owned progress remains intentionally separate from any later physical scheduler selection.

The remaining evaluator/output/resource/progress/session proposals then receive bounded normalized Search IR/Composer and universal reference evidence before one integrated semantic-acceptance gate. Production lowering remains blocked until that acceptance gate completes.
