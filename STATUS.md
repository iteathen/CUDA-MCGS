...
Current focus is **ENGINE-IR-COMPOSER-01**. Its [critical assessment and focus map](docs/development/2026-08-25-engine-ir-composer-01-assessment-and-plan.md) preserves accepted Search IR 0.1.0 and sequences owner-composed proposal Search IR 0.2.0 through exact contract cataloging, strict schemas, normalization, deterministic reference composition, package projection and deletion/identity evidence. `IR-CATALOG-01` through `IR-EVALUATOR-01` are integrated through PRs #90/#91/#92/#93/#94/#95 at `main@ed4baa2`. `IR-RESOURCE-01` now has a strict finite logical-resource schema/normalizer, three evaluator-absent/evaluator-workspace/live-session plans, exact contribution composition, checked arbitrary-width formulas, partitions/reserves/admission/ledgers/pressure/exhaustion/lifecycle/provider projection and a 381-case focused candidate; integration is pending. The coverage index has final evidence lanes for 543 framework/domain/graph/policy/evaluator/resource requirements, all still partial, pending or deferred rather than complete; 446 requirements remain for later owners. Production lowering remains blocked until schema/reference evidence and the later integrated semantic-acceptance gate complete.
