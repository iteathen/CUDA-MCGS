...
`REF-HARNESS-01` supplies the semantic-neutral foundation through the [`search-semantics-reference`](experiments/search-semantics-reference/README.md) experiment. Its 22 neutral cases are rebound to the qualified Composer representation key `bbe8645637244392d0ffe9347417204dad3e675efccdc29043fd197e1d12cd56`; the harness semantics themselves remain unchanged.

`REF-DOMAIN-01` still contributes the same 27 Domain cases and exact 47 direct SPEC-0007 behavioral requirements, but its public projection/evidence bindings were regenerated because the proposal-derived Composer identity changed. The current projection identity is `3ec9521040b12f69a3d5bcd308ec540c3d1c4d2d870f409c9027738c132423d8`; the full 49/49 semantic-reference evidence identity is `7afd8930a9af337be0ecbc5bff930ea21444ddb1afa6bf261c083db5cb95bd5b`. Historical projection `612c72274be7986bcae53237be97b34e64d97a781eeb55e61964d11b942b9f47` and semantic key `70f5c454b7d31cd18374350fd75ebd52b961c828e515b0e6eabeefb8499b6402` remain truthful only for their exact earlier proposal input. Graph remains blocked until PR #127 integrates.
