...
NVIDIA CUDA software and headers, CUDA-JS, third-party libraries, research implementations, and any other external inputs retain their own licenses. CUDA-MCGS does not relicense them merely by referencing, testing against, linking to, or interoperating with them.

Any third-party implementation copied, adapted, or vendored into CUDA-MCGS must retain exact provenance and license notices and must pass the repository's explicit reuse/licensing review before integration. Methodology or ideas referenced without copying source remain subject to their applicable legal boundaries.

This summary is informational. The AGPL text and any separately executed commercial or contributor agreement control their respective grants.
