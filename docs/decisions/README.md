...
- [`ADR-0018-universal-core-extension-product-layering.md`](ADR-0018-universal-core-extension-product-layering.md) — separate mandatory universal MCGS semantics, the least-authority extension/composition substrate, and downstream product meaning.
- [`ADR-0027-framework-only-production-ownership.md`](ADR-0027-framework-only-production-ownership.md) — keep all production domain products in their owning repositories and retain only product-neutral framework/conformance ownership here.
