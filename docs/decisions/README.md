...
- [`ADR-0021-separate-attention-from-root-advance.md`](ADR-0021-separate-attention-from-root-advance.md) — keep directional attention as a lazy independently versioned publication, reserve root transactions for structural root advance, and omit root-independent owners and global multi-GPU barriers.
