...
- [`SPEC-0006-search-session-control-and-observation.md`](SPEC-0006-search-session-control-and-observation.md) — optional structural root-transaction/root-epoch, independent bounded attention and observation-request lifecycle coordination, with source-owner reuse/stale/publication semantics, device-owned progress and exact terminal-only zero residue.
