...
- optional external Search Session root transactions, independent attention publications and observation-request/borrow coordination across source-owned stale-work, reuse, reclamation and publication semantics;
