...
| `EXT-COMPOSE-01` | `active` | Decision-complete restricted Device-JS extension composition/package proposal | Integrated SPEC-0003/4; SPEC-0005; SPEC-0000; ADR-0019; CUDA-JS Device-JS/public package contracts | Revised SPEC-0005 | CUDA-MCGS owns/interprets CUDA source/artifacts, runtime discovery remains, absent capability leaves semantic/source/package residue or native topology becomes universal. |
