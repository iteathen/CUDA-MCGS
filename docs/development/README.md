...
[`2026-08-25-engine-ir-composer-01-assessment-and-plan.md`](2026-08-25-engine-ir-composer-01-assessment-and-plan.md) is the active critical assessment and semantic focus-branch map for `ENGINE-IR-COMPOSER-01`. It preserves accepted Search IR 0.1.0, introduces owner-composed proposal Search IR 0.2.0 as bounded schema/reference evidence, and currently routes the `SESSION-ATTENTION-01` correction before cross-profile deletion/identity reconciliation. ADR-0021 splits lazy directional attention from structural root advance without changing the 989 requirement IDs or authorizing production/native work.
