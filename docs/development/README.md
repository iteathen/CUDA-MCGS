...
[`2026-08-25-linux-first-native-execution-direction.md`](2026-08-25-linux-first-native-execution-direction.md) records the project-owner/CUDA-JS ADR-0006 transition: native Linux x86-64 is the reference for the first exact compatible pair and finite universal engine, Ubuntu 24.04 LTS is the first exact qualification cell, and Windows remains a separately maintained evidence/profile lane.
