...
[`2026-08-25-engine-reference-01-assessment-and-plan.md`](2026-08-25-engine-reference-01-assessment-and-plan.md) is the current critical assessment and semantic focus map for `ENGINE-REFERENCE-01`. It assigns behavioral evidence to independently replaceable owner oracles, preserves existing Channel evidence with its owner, keeps the harness semantic-neutral and schedules one complete terminal CUDA-free slice before optional live Session/Stage/Channel integration. It is a reference/conformance plan, not production or native authority.
