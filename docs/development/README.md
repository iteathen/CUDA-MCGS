...
[`2026-08-25-engine-ir-composer-01-assessment-and-plan.md`](2026-08-25-engine-ir-composer-01-assessment-and-plan.md) is the active critical assessment and semantic focus-branch map for `ENGINE-IR-COMPOSER-01`. It preserves accepted Search IR 0.1.0, introduces owner-composed proposal Search IR 0.2.0 as bounded schema/reference evidence, and sequences exact 989-requirement coverage before owner schemas and deterministic composition.
