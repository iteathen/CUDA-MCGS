...
[`2026-08-24-engine-contract-01-assessment-and-plan.md`](2026-08-24-engine-contract-01-assessment-and-plan.md) is the critical assessment and full-attention focus-branch map for the active `ENGINE-CONTRACT-01` node. It separates domain, graph, policy, evaluator, output, finite-resource, device-owned progress, Search Session, framework-map and integration outputs; only `EC-DOMAIN-01` is initially dependency-ready.
