...
[`2026-08-12-v0-forward-plan.md`](2026-08-12-v0-forward-plan.md) is the canonical lower-authority forward plan. It begins with product-neutral semantic contract acceptance, then the schema-backed selected-only extension substrate, Search IR/Composer integration, universal reference/conformance, downstream Connect Four external deletion, finite native engine work, optional live-session profile, Linux/performance continuation, and release stabilization.
