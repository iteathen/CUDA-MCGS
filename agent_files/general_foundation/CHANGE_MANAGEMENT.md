...
Accepted records are not rewritten to hide history. Add a superseding ADR/spec and link both directions. Archive stale material with original path, date, revision, reason, and replacement authority.
