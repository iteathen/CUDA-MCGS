...
| `conformance` | Universal reference backend, materially varied removable domains/workloads, search-contract suites, and public peer/external-consumer boundary compatibility | [`../conformance/`](../conformance/README.md) | Active; Search Compiler, installed-library-interface and portable CUDA-JS adapter/exact-pair conformance are active while independent reference experiments remain bounded evidence |
