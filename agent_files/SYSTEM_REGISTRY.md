...
| `evidence.search-semantics-harness` | Semantic-neutral finite declared-schedule execution, exact owner-state isolation, immutable public facts, mutation sensitivity and source-keyed evidence bound to the proposal Composer key | [`../experiments/search-semantics-reference/`](../experiments/search-semantics-reference/README.md) | Active bounded reference harness; owner-specific search behavior, production and native authority remain pending |
...
| `contract.policy` | Product-neutral selection/reservation/widening/policy statistics/backup/stopping and root-advance reuse classification | [`../docs/specs/SPEC-0008-search-policy-and-backup.md`](../docs/specs/SPEC-0008-search-policy-and-backup.md) proposal |
| `contract.evaluator` | Resident evaluator semantics/capabilities/batching/workspace/publication and root-advance cache validity | [`../docs/specs/SPEC-0009-evaluator-contract.md`](../docs/specs/SPEC-0009-evaluator-contract.md) proposal |
...
| `contract.session` | Optional external Search Session coordination with affected-owner structural root transactions, independently versioned lazy attention publication, cancellation and observation-request/borrow lifecycles; source owners retain reuse/stale/publication/resource/progress meaning | [`../docs/specs/SPEC-0006-search-session-control-and-observation.md`](../docs/specs/SPEC-0006-search-session-control-and-observation.md) proposal |
