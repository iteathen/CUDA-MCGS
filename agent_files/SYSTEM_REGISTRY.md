...
|---|---|---|---|
| `schemas` | Versioned CUDA-MCGS machine-readable universal and namespaced selected contracts/metaschemas | [`../schemas/`](../schemas/README.md) | Active; Search IR 0.1.0 accepted, 0.2.0 proposal catalog/foundation/domain evidence active |
