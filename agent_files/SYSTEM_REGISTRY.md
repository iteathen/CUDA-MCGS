...
| `integration.cuda-js-tensor-evaluator` | Public Tensor callable admission; evaluator-owned request/batch/result/staging and aggregate service/quiescence callables; exact Program identity; Resource-owned placement and complete operation pointer bindings with explicitly selected immutable artifacts | [`../adapters/evaluators/cuda-js-tensor/`](../adapters/evaluators/cuda-js-tensor/README.md) | PR #262 protects the foundation. The fresh #124 candidate adds immutable input/pointer composition and a bounded Progress cohort with runtime cleanup/quarantine evidence. Proposed package contracts, general engine closure and physical qualification remain under review/open. |
