...
- [`search-ir-composer-reference/`](search-ir-composer-reference/) — CUDA-free proposal Search IR 0.2.0 catalog/normalizer/reference-Composer capsule; its first slice freezes the twelve-contract, 989-requirement input and honest owner routing without replacing accepted Search IR 0.1.0 or claiming completed owner evidence.
