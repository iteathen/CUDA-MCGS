...
- [`search-ir-composer-reference/`](search-ir-composer-reference/) — CUDA-free proposal Search IR 0.2.0 catalog/normalizer/reference-Composer capsule; it freezes the twelve-contract, 989-requirement input and now validates shared representation primitives plus the owner-selection/public-binding envelope without replacing accepted Search IR 0.1.0 or defining owner-private semantics.
