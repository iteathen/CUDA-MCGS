...
- [`search-ir-composer-reference/`](search-ir-composer-reference/) — CUDA-free proposal Search IR 0.2.0 catalog/normalizer/reference-Composer capsule; it freezes the twelve-contract, 989-requirement input, validates shared representation primitives and the owner-selection/public-binding envelope, and now carries the bounded domain-owner profile slice without replacing accepted Search IR 0.1.0 or claiming behavioral/native qualification.
