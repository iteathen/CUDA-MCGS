...
- [`search-ir-composer-reference/`](search-ir-composer-reference/) — CUDA-free proposal Search IR 0.2.0 catalog/normalizer/reference-Composer capsule; it freezes the twelve-contract, 989-requirement input, validates strict owner profiles and resolved material-default provenance, statically composes canonical restricted Device-JS Search Programs and consumer-neutral public execution-package requests, and proves bounded convenience equivalence, failure atomicity, deletion/identity and reference-pair behavior without replacing accepted Search IR 0.1.0 or claiming a public SDK, production implementation or native qualification.
