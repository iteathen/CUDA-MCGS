...
This preserves the detailed record from [CUDA-MCGS revision 67d6874](https://github.com/iteathen/CUDA-MCGS/blob/67d687466689d78856fb2ff7ef1ffa4ae3b756da/experiments/search-semantics-reference/README.md). Its branch names, counts, proposal states, and next actions are historical. Use [the README](README.md) and [current status](../../STATUS.md) for present orientation.
