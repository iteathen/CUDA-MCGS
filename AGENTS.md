...
- The first usable native engine is parallel, not a serial search loop moved onto a GPU. Semantics remain physical-scheduler-neutral; selected profiles own and qualify their grid/block/warp/queue/kernel mapping, and advanced or tensor mechanisms require concrete measured evidence rather than speculative universalization.
